...
<br />
        ...
        <br>
          <div><span style="font-weight: bold;">Phone No</span> : +${Phone}</div>
        <br>
          <div><span style="font-weight: bold;">Email</span> : ${Email}</div>
        <br>
          <div><span style="font-weight: bold;">Number od Guests</span> : ${adult} adults and ${child} child</div>
        <br>
          <div><span style="font-weight: bold;">Check-in and Check-out </span> : ${firstdate} - ${seconddate}</div>
        <br>
          <div><span style="font-weight: bold;">Selected Room </span> : ${Roomname}</div>
        <br>
          <div><span style="font-weight: bold;">Total NIght </span> : ${total}</div>
          <br>
        <br>
          <div style="display: flex; justify-content : space-between; ">
            <div><p style="font-weight: bold;">Amount</p><p style="text-align: center;">${charge}</p></div>
            <div><p style="font-weight: bold;">TAX & GST</p ><p style="text-align: center;">${tax}</p></div>
            <div><p style="font-weight: bold;">TOTAL</p><p style="text-align: center;">${totalcharge}</p></div>
          </div>
          <br>
          <div>Please feel free to reach out if you have any further requests or if there's anything else we can assist you with. We
            <br /> want to ensure that your visit with us is absolutely perfect.</div>
        <br>
            <div style="display: flex; justify-content : space-between;">
              <div>Phone Number : +91 245 151 1556</div>
...
<div style="text-align: center;">We are thrilled to inform you that your reservation at The West 
  ...
  <div><span style="font-weight: bold;">Name</span> : ${Name}</div>
<br>
  <div><span style="font-weight: bold;">Surename No</span> : ${Surename}</div>
<br>
  <div><span style="font-weight: bold;">Email</span> : ${Email}</div>
<br>
